...
window.CATALOGO = (function () {
  ...
  const productos = {
    ...
    'aove-coupage': {
      ...
      formatos: [
        { formato: '1 L',  precio: 8.50,  imagen: BASE_IMG + 'aove-coupage-1l.jpg' },
        { formato: '5 L',  precio: 38.90, imagen: BASE_IMG + 'aove-coupage-5l.jpg' }
      ],
      cata: {
    ...
    'olixicar': {
      ...
      formatos: [
        { formato: '5 L', precio: 32.50, imagen: BASE_IMG + 'olixicar-5l.jpg' }
      ],
      cata: {
    ...
    'dcoop-especial': {
      ...
      formatos: [
        { formato: '1 L',     precio: 9.20,  imagen: BASE_IMG + 'dcoop-especial-1l.jpg' },
        { formato: '5 L',     precio: 41.50, imagen: BASE_IMG + 'dcoop-especial-5l.jpg' },
        { formato: 'Lata 3 L', precio: 26.90, imagen: BASE_IMG + 'dcoop-especial-lata-3l.jpg' }
      ],
      cata: {
    ...
    'dcoop-seleccion-picual': {
      ...
      formatos: [
        { formato: '250 ml', precio: 6.50, imagen: BASE_IMG + 'dcoop-seleccion-picual-250ml.jpg' }
      ],
      cata: {
    ...
    'dcoop-seleccion-hojiblanca': {
      ...
      formatos: [
        { formato: '250 ml', precio: 6.50, imagen: BASE_IMG + 'dcoop-seleccion-hojiblanca-250ml.jpg' }
      ],
      cata: {
    ...
    'dcoop-seleccion-arbequina': {
      ...
      formatos: [
        { formato: '250 ml', precio: 6.50, imagen: BASE_IMG + 'dcoop-seleccion-arbequina-250ml.jpg' }
      ],
      cata: {
    ...
    'unico-frutado': {
      ...
      formatos: [
        { formato: '500 ml', precio: 18.90, imagen: BASE_IMG + 'unico-frutado.jpg' }
      ],
      cata: {
